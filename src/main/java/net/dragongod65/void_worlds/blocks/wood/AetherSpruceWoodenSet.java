...
public class AetherSpruceWoodenSet {

    public static Block aether_spruce_log;
    public static Block aether_spruce_wood;
    public static Block stripped_aether_spruce_log;
    public static Block stripped_aether_spruce_wood;

    public static Block aether_spruce_wood_planks;
    public static Block aether_spruce_wood_pressure_plate;
    public static Block aether_spruce_wood_stair;
    public static Block aether_spruce_wood_slab;
    public static Block aether_spruce_wood_button;
    public static Block aether_spruce_wood_fence;
    public static Block aether_spruce_wood_fence_gate;
    public static Block aether_spruce_wood_sign;
    public static Block aether_spruce_wood_boat;



    public static void init() {

        createAetherSpruceLog();
    }
    
    private static void createAetherSpruceLog() {
