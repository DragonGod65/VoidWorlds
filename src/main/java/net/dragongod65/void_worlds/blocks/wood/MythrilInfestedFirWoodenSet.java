...
public class MythrilInfestedFirWoodenSet {

    public static Block mythril_infested_fir_log;
    public static Block mythril_infested_fir_wood;
    public static Block stripped_mythril_infested_fir_log;
    public static Block stripped_mythril_infested_fir_wood;

    public static Block mythril_infested_fir_wood_planks;
    public static Block mythril_infested_fir_wood_pressure_plate;
    public static Block mythril_infested_fir_wood_stair;
    public static Block mythril_infested_fir_wood_slab;
    public static Block mythril_infested_fir_wood_button;
    public static Block mythril_infested_fir_wood_fence;
    public static Block mythril_infested_fir_wood_fence_gate;
    public static Block mythril_infested_fir_wood_sign;
    public static Block mythril_infested_fir_wood_boat;



    public static void init() {

        createMythrilInfestedFirLog();
    }
    
    private static void createMythrilInfestedFirLog() {
        ...
        mythril_infested_fir_log = block;
    }
