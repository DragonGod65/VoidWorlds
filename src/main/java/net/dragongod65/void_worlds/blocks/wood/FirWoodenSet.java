...
public class FirWoodenSet {
    ...
    public static Block fir_wood_planks;
    public static Block fir_wood_pressure_plate;
    public static Block fir_wood_stair;
    public static Block fir_wood_slab;
    public static Block fir_wood_button;
    public static Block fir_wood_fence;
    public static Block fir_wood_fence_gate;
    public static Block fir_wood_sign;
    public static Block fir_wood_boat;
    ...
    private static void createFirLog() {
